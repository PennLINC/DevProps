...
saveRDS(TD_L_edr2,paste0('/cbica/projects/pinesParcels/results/PWs/LTDL_cedr2.rds'))
saveRDS(BU_L_edr2,paste0('/cbica/projects/pinesParcels/results/PWs/LBUL_cedr2.rds'))
saveRDS(BuProp_edr2,paste0('/cbica/projects/pinesParcels/results/PWs/LBUProp_cedr2.rds'))
saveRDS(ThetasFromPG_edr2,paste0('/cbica/projects/pinesParcels/results/PWs/LThetasFromPG_cedr2.rds'))

saveRDS(TD_L_ep,paste0('/cbica/projects/pinesParcels/results/PWs/LTDL_cep.rds'))
saveRDS(BU_L_ep,paste0('/cbica/projects/pinesParcels/results/PWs/LBUL_cep.rds'))
saveRDS(BuProp_ep,paste0('/cbica/projects/pinesParcels/results/PWs/LBUProp_cep.rds'))
saveRDS(ThetasFromPG_ep,paste0('/cbica/projects/pinesParcels/results/PWs/LThetasFromPG_cep.rds'))
