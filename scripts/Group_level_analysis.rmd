...
# correct to be degrees rather than histogram bin index
plotdataf<-data.frame(seq(10,170,10),y_disthistModes)
# correct to be degrees rather than histogram bin index
...
#plotting
BuDs<-ggplot(BuMerge,aes(x=Ds,y=1-BuProp))+geom_point(size=3,alpha=.5)+theme_classic(base_size=30)+geom_smooth(method='lm',color='black')
BuDs+xlab('Dip Statistics')+ylab('Top-Down')+scale_y_continuous(labels = percent_format(accuracy = 1))
```
