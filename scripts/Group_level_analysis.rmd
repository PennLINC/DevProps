...
visreg(gam(BuProp~s(interview_age,k=4)+FD+sex,data=BuMerge))
summary(lm(BuProp~interview_age+FD+sex,data=BuMerge))
model1<-gam(BuProp~s(interview_age,k=4)+FD+sex,data=BuMerge)
model2<-gam(BuProp~FD+sex,data=BuMerge)
a<-anova.gam(model1,model2)
```
