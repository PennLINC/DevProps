...
# get delta adjusted r^2
adjR2=summary(gam(TDProp~s(interview_age,k=4)+FD+sex+RemainingTRs+DMNseg,data=BuMerge))$r.sq
adjR2_noage=summary(gam(TDProp~FD+sex+RemainingTRs+DMNseg,data=BuMerge))$r.sq
adjR2-adjR2_noage
...
# DMN model - individualized
summary(gam(DMNseg~s(interview_age,k=4)+FD+sex+RemainingTRs+TDProp,data=BuMerge))
devMod_DM<-gam(DMNseg~s(interview_age,k=4)+FD+sex+RemainingTRs+TDProp,data=BuMerge)
ndevMod_DM<-gam(DMNseg~FD+sex+RemainingTRs+TDProp,data=BuMerge)

# get delta adjusted r^2
adjR2=summary(gam(DMNseg~s(interview_age,k=4)+FD+sex+RemainingTRs+TDProp,data=BuMerge))$r.sq
adjR2_noage=summary(gam(DMNseg~FD+sex+RemainingTRs+TDProp,data=BuMerge))$r.sq
adjR2-adjR2_noage

# get p-value
anovaRes<-anova.gam(devMod_DM,ndevMod_DM,test='Chisq')
anovaRes$`Pr(>Chi)`
```
