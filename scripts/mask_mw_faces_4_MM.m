...
AngDistFP=['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_Myelin_AngDistMat4.mat'];
data=load(AngDistFP)
...
writetable(table(gAngD_L_masked),['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_MyAngDist_Masked4_L.csv']);
writetable(table(gAngD_R_masked),['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_MyAngDist_Masked4_R.csv']);
