...
plotdataf<-data.frame(histoVers1$cnt[1:18]/sum(histoVers1$cnt[1:18]),histoVers2$cnt[1:18]/sum(histoVers2$cnt[1:18]),histoVers3$cnt[1:18]/sum(histoVers3$cnt[1:18]),histoVers4$cnt[1:18]/sum(histoVers4$cnt[1:18]),seq(1,18))

colnames(plotdataf)<-c('s1','s2','s3','s4','seq')
