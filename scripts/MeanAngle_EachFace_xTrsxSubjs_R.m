...
OpMeanMeanDifFromPGGVec_R=zeros(1,length(azd_R));
for i=1:length(azd_R)
    ...
    OpMeanMeanDifFromPGGVec_R(i)=FacemeanmeanDirs(i)-PGGAng;
end
...
OpMeanMeanDifFromPGGVec_R=OpMeanMeanDifFromPGGVec_R(g_noMW_combined_R);
writetable(table(OpMeanMeanDifFromPGGVec_R),'~/data/MeanMeanPGGDif_R.csv')
