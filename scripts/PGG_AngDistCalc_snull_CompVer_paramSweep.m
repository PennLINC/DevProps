function PGG_AngDistCalc_snull_paramSweep(subj)
...
OpFlFp=['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_OpFl_fs4_' alphaFN '.mat'];
data=load(OpFlFp)
...
% save it out
SpunAngDistFP=['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_SpunDips4_' alphaFN '.csv'];
