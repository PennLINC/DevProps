...
TRs_lfp=['/cbica/projects/pinesParcels/results/PWs/PreProc/' subj '/' subj '_AggTS_L_c_10k.mgh'];
TRs_rfp=['/cbica/projects/pinesParcels/results/PWs/PreProc/' subj '/' subj '_AggTS_R_c_10k.mgh'];
% filepaths to files
...
CSIfp = [parentfp subj '/' subj '_ses-baselineYear1Arm1_task-carit_ValidSegments_Trunc.txt'];
CSI = readtable(CSIfp);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
save(['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_OpFl_fs5_c.mat'],'us')
