...
saveRDS(TD_R_edr2,paste0('/cbica/projects/pinesParcels/results/PWs/RTDL_fedr2.rds'))
saveRDS(BU_R_edr2,paste0('/cbica/projects/pinesParcels/results/PWs/RBUL_fedr2.rds'))
saveRDS(BuProp_edr2,paste0('/cbica/projects/pinesParcels/results/PWs/RBUProp_fedr2.rds'))
saveRDS(ThetasFromPG_edr2,paste0('/cbica/projects/pinesParcels/results/PWs/RThetasFromPG_fedr2.rds'))

saveRDS(TD_R_ep,paste0('/cbica/projects/pinesParcels/results/PWs/RTDL_fep.rds'))
saveRDS(BU_R_ep,paste0('/cbica/projects/pinesParcels/results/PWs/RBUL_fep.rds'))
saveRDS(BuProp_ep,paste0('/cbica/projects/pinesParcels/results/PWs/RBUProp_fep.rds'))
saveRDS(ThetasFromPG_ep,paste0('/cbica/projects/pinesParcels/results/PWs/RThetasFromPG_fep.rds'))
