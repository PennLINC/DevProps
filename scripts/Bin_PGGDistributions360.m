...
Subjs=readtable('~/PWs/rs_cmatch_subs.csv','Format','auto');
...
% save outdf
fn=['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_c_AngDistHist.mat'];
save(fn,'OutDf')

fn=['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_c_DistHist.csv'];
writetable(table(OutDf),fn)


% save facial modes
fn=['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_c_AngDistFacial_360ModesL.csv'];
writetable(table(faceModesL),fn)
fn=['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_c_AngDistFacial_360ModesR.csv'];
