...
```{r}
# big linear models
Internalizing<-lm(RestRat~interview_age+sex.x+TRs_r+mri_info_deviceserialnumber+rsfmri_c_ngd_meanmotion+rsfmri_c_ngd_dt_ngd_dla+cbcl_scr_syn_internal_r+mri_info_manufacturer,data=masterdf)
