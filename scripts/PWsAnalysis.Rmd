...
hist(restG_LM$PGCor,breaks = seq(-1,1,by=.05))
hist(restG_gPG_LM$PGCor,breaks = seq(-1,1,by=.05))
# group level waves, assess parameter sweep
restG_6_8<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_60_8')
restG_6_10<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_60_10')
restG_6_12<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_60_12')

h68<-hist(restG_6_8$PGCor,breaks = seq(-1,1,by=.05))
h610<-hist(restG_6_10$PGCor,breaks = seq(-1,1,by=.05))
h612<-hist(restG_6_12$PGCor,breaks = seq(-1,1,by=.05))

restG_7_8<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_70_8')
restG_7_10<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_70_10')
restG_7_12<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_70_12')

h78<-hist(restG_7_8$PGCor,breaks = seq(-1,1,by=.05))
h710<-hist(restG_7_10$PGCor,breaks = seq(-1,1,by=.05))
h712<-hist(restG_7_12$PGCor,breaks = seq(-1,1,by=.05))


restG_8_8<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_80_8')
restG_8_10<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_80_10')
restG_8_12<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_80_12')

h88<-hist(restG_8_8$PGCor,breaks = seq(-1,1,by=.05))
h810<-hist(restG_8_10$PGCor,breaks = seq(-1,1,by=.05))
h812<-hist(restG_8_12$PGCor,breaks = seq(-1,1,by=.05))
