...
masterdf$tfmri_mid_all_beh_lrwpfb_nt<-as.numeric(masterdf$tfmri_mid_all_beh_srwpfb_nt)
```
...
Age<-lm(rsfmri_c_ngd_dt_ngd_dla~interview_age+sex+mri_info_deviceserialnumber+mri_info_manufacturer+rsfmri_c_ngd_meanmotion,data=masterdf)
