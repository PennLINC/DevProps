...
ggplot(masterdf2,aes(rsfmri_c_ngd_dt_ngd_dt,numTD_r))+geom_point(alpha=.6)+geom_smooth(method='lm')+xlab('Within-DMN FC')+ylab('Number of Top-down Waves')+theme_classic(base_size=33)
ggplot(masterdf2,aes(rsfmri_c_ngd_dt_ngd_dla,numTD_r))+geom_point(alpha=.6)+geom_smooth(method='lm')+xlab('DMN-DAN FC')+ylab('Number of Top-down Waves')+theme_classic(base_size=33)
ggplot(masterdf2,aes(rsfmri_c_ngd_dt_ngd_dt,numBU_r))+geom_point(alpha=.6)+geom_smooth(method='lm')+xlab('Within-DMN FC')+ylab('Number of Bottom-up Waves')+theme_classic(base_size=33)
ggplot(masterdf2,aes(rsfmri_c_ngd_dt_ngd_dla,numBU_r))+geom_point(alpha=.6)+geom_smooth(method='lm')+xlab('DMN-DAN FC')+ylab('Number of Bottom-up Waves')+theme_classic(base_size=33)


ggplot(masterdf2,aes(X12_12rest,numTD_r))+geom_point(alpha=.6)+geom_smooth(method='lm')+xlab('Within-DMN FC Ind')+ylab('Number of Top-down Waves')+theme_classic(base_size=33)
ggplot(masterdf2,aes(X5_12rest,numTD_r))+geom_point(alpha=.6)+geom_smooth(method='lm')+xlab('DMN-DAN FC')+ylab('Number of Top-down Waves')+theme_classic(base_size=33)
ggplot(masterdf2,aes(X12_12rest,numBU_r))+geom_point(alpha=.6)+geom_smooth(method='lm')+xlab('Within-DMN FC')+ylab('Number of Bottom-up Waves')+theme_classic(base_size=33)
ggplot(masterdf2,aes(X5_12rest,numBU_r))+geom_point(alpha=.6)+geom_smooth(method='lm')+xlab('DMN-DAN FC')+ylab('Number of Bottom-up Waves')+theme_classic(base_size=33)
...
InternalizingLM<-lm(numBU_r~interview_age+sex.x+mri_info_deviceserialnumber+TRs_r+rsfmri_c_ngd_meanmotion+nihtbx_totalcomp_uncorrected+mri_info_manufacturer,data=masterdf)
