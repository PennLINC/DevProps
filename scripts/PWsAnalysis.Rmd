...
restG_6<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_60')
restG_6_15<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_60_z1p5')
restG_6_2<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_60_z2')

h6<-hist(restG_6$PGCor,breaks = seq(-1,1,by=.05))
h615<-hist(restG_6_15$PGCor,breaks = seq(-1,1,by=.05))
h62<-hist(restG_6_2$PGCor,breaks = seq(-1,1,by=.05))

restG_7<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_70')
restG_7_15<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_70_z1p5')
restG_7_2<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_70_12')

h7<-hist(restG_7$PGCor,breaks = seq(-1,1,by=.05))
h715<-hist(restG_7_15$PGCor,breaks = seq(-1,1,by=.05))
h72<-hist(restG_7_2$PGCor,breaks = seq(-1,1,by=.05))


restG_66<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_66')
restG_66_15<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_66_z15')
restG_66_2<-readRDS('/cbica/projects/abcdfnets/results/restGroup-level_waves_66_z2')

h66<-hist(restG_66$PGCor,breaks = seq(-1,1,by=.05))
h6615<-hist(restG_66_15$PGCor,breaks = seq(-1,1,by=.05))
h662<-hist(restG_66_2$PGCor,breaks = seq(-1,1,by=.05))
