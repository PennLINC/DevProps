...
fp=strjoin([fpParent 'task-' task '_DCANBOLDProc_v4.0.0_Atlas.dtseries.nii'],'');
...
if exist(fp,'file')
	...
	C_ind=1:59412;
	% load in mask
	masfp=strjoin(['/cbica/projects/hcpd/data/motion/fd/' sname '/ses-V1/files/DCANBOLDProc_v4.0.0/analyses_v2/motion/task-' task '_power_2014_motion.mat'],'');
	if exist(masfp,'file')
		mask=load(masfp);
		...
		Threshold=25;			% find changepoints in binary bask
