...
templatefileFP=paste0('/cbica/projects/pinesParcels/results/PWs/Proced/', subj, '/', subj, '_CircFC_L_pt', as.character(iter), '.rds')
...
for (s in 1:remainingSubjs){
	...
	fp=paste0('/cbica/projects/pinesParcels/results/PWs/Proced/', subj, '/', subj, '_CircFC_L_pt', as.character(iter), '.rds')
...
DR2VecName=paste('/cbica/projects/pinesParcels/results/PWs/Age_EdgeLeve_CFC_L_DR2_',iter,'.rds',sep='')
