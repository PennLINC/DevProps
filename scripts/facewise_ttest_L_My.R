...
for (f in 1:Lfaces){
	...
	for (s in 1:remainingSubjs){
	    subj=df$SubjID[s]
	    ResFP_L=paste0('/cbica/projects/pinesParcels/results/PWs/Proced/',subj,'/',subj,'_BUTD_L_My.csv')
	    # load in dat data
	    Res=read.csv(ResFP_L)
    	    ResFP_L_c=paste0('/cbica/projects/pinesParcels/results/PWs/Proced/',subj,'/',subj,'_BUTD_L_My_c.csv')
            # load in dat data
...
saveRDS(T_L,paste0('/cbica/projects/pinesParcels/results/PWs/r_vs_c_t_L_My.rds'))
saveRDS(p_L,paste0('/cbica/projects/pinesParcels/results/PWs/r_vs_c_p_L_My.rds'))
