...
%% system('export PATH=/cbica/projects/hcpd/aws/dist/:$PATH')

% echo subj name into a .txt
%% subjTxtCommand=['echo ' subj ' >> /cbica/projects/hcpd/nda-abcd-s3-downloader/' subj '.txt'];
...
%%% LOCAL!
% download subject's data from the 10_2 dataset manifest
