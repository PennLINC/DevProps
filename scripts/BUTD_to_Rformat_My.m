...
for s=1:numSubjs
	...
	csv_L=table(matL(:,1));
	csv_R=table(matR(:,1));
	writetable(csv_L,['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_BUTD_L_My.csv'])
	writetable(csv_R,['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_BUTD_R_My.csv'])
end
