...
Cog$F1<-Cog$nih_fluidcogcomp_unadjusted
...
for (f in 1:4851){
	...
	for (s in 1:remainingSubjs){
        ...
        # extract EF dr2
        TD_L_edr2[f]=EFDeltaR2EstVec(df$FaceTd_rv)
        # extract age dr2
        BU_L_edr2[f]=EFDeltaR2EstVec(df$FaceBu_rv)
        # extract age dr2
	...
	# extract EF p
        TD_L_ep[f]=EFDeltaPEstVec(df$FaceTd_rv)
        # extract age p
        BU_L_ep[f]=EFDeltaPEstVec(df$FaceBu_rv)
        # extract age p
...
saveRDS(TD_L_edr2,paste0('/cbica/projects/pinesParcels/results/PWs/LTDL_fedr2.rds'))
saveRDS(BU_L_edr2,paste0('/cbica/projects/pinesParcels/results/PWs/LBUL_fedr2.rds'))
saveRDS(BuProp_edr2,paste0('/cbica/projects/pinesParcels/results/PWs/LBUProp_fedr2.rds'))
saveRDS(ThetasFromPG_edr2,paste0('/cbica/projects/pinesParcels/results/PWs/LThetasFromPG_fedr2.rds'))

saveRDS(TD_L_ep,paste0('/cbica/projects/pinesParcels/results/PWs/LTDL_fep.rds'))
saveRDS(BU_L_ep,paste0('/cbica/projects/pinesParcels/results/PWs/LBUL_fep.rds'))
saveRDS(BuProp_ep,paste0('/cbica/projects/pinesParcels/results/PWs/LBUProp_fep.rds'))
saveRDS(ThetasFromPG_ep,paste0('/cbica/projects/pinesParcels/results/PWs/LThetasFromPG_fep.rds'))
