...
saveRDS(BuProp_adr2,paste0('/cbica/projects/pinesParcels/results/PWs/LBUProp_adr2_My.rds'))
#saveRDS(BuProp_sdr2,'/cbica/projects/pinesParcels/results/PWs/LBUProp_sdr2.rds')

saveRDS(BuProp_ap,paste0('/cbica/projects/pinesParcels/results/PWs/LBUProp_p_My.rds'))
