function us = OpFl_Sph_fs4_runSweep_msc(subj)
...
TRs_lfp=['/cbica/projects/pinesParcels/results/PWs/PreProc/' subj '/' subj '_AggTS_L_3k_run_' runstring '.mgh'];
TRs_rfp=['/cbica/projects/pinesParcels/results/PWs/PreProc/' subj '/' subj '_AggTS_R_3k_run_' runstring '.mgh'];
% filepaths to files
...
parentfp = '/cbica/projects/pinesParcels/data/msc/motMasked_contSegs/';
CSIfp = [parentfp subj '/' subj '_ses-baselineYear1Arm1_task-rest_ValidSegments_Trunc_run_' runstring '.txt'];
CSI = readtable(CSIfp);
...
% saveout with run denoted
save(['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_OpFl_fs4_run_' runstring '.mat'],'us')
end
