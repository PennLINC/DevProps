...
% save output - note mygg is misnomer, really loading in my, printing out myg
save('/cbica/projects/pinesParcels/results/aggregated_data/MyGGPermuts_fs4.mat','spGPGGs')
