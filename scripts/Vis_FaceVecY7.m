...
mincol=0;
maxcol=8;
% repurposing for y7 coloration
roybigbl_cm=inferno(9);
roybigbl_cm(1,:)=[50, 50, 50];
roybigbl_cm(2,:)=[131, 66, 135];
roybigbl_cm(3,:)=[91, 137, 193];
roybigbl_cm(4,:)=[64, 152, 69];
roybigbl_cm(5,:)=[196, 88, 196];
roybigbl_cm(6,:)=[229, 229, 189];
roybigbl_cm(7,:)=[239, 185, 66];
roybigbl_cm(8,:)=[211, 79, 98];
roybigbl_cm(9,:)=[180, 180, 180];
