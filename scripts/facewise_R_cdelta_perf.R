...
for (f in 1:4842){
	...
	for (s in 1:remainingSubjs){
	    ...
	    ResFP_rsL=paste0('/cbica/projects/pinesParcels/results/PWs/Proced/',subj,'/',subj,'_BUTD_R.csv')
	    # if output exists
...
saveRDS(BuProp_edr2,paste0('/cbica/projects/pinesParcels/results/PWs/RBUProp_delta_edr2.rds'))

saveRDS(BuProp_ep,paste0('/cbica/projects/pinesParcels/results/PWs/RBUProp_delta_ep.rds'))
