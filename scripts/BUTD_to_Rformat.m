...
for s=1:numSubjs
	...
	writetable(csv_L,['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_BUTD_L.csv'])
	writetable(csv_R,['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_BUTD_R.csv'])
end
