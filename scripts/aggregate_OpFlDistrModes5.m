...
for s = 1:height(Subjs)
	...
	% if file exists, then
	if isfile([fp '/' Subj{:} '_AngDistMat5.mat']);
		s
...
%save
writetable(table(OutArray_L),'/cbica/projects/pinesParcels/results/PWs/ModeModes5_L.csv');
writetable(table(OutArray_R),'/cbica/projects/pinesParcels/results/PWs/ModeModes5_R.csv');
