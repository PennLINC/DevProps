...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% load in unsmoothed PG for masking mw out, using PGG transform
gpg=load('~/data/gpg_fs5unsmoothed.mat');
...
% mask vector
g_noMW_combined_L=setdiff([1:20480],gPGg_L0);
g_noMW_combined_R=setdiff([1:20480],gPGg_R0);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
sp_PGGs=load('/cbica/projects/pinesParcels/results/aggregated_data/PGGPermuts_fs5.mat');

gazes_L_all=squeeze(sp_PGGs.spGPGGs(1,:,1:20480));
gels_L_all=squeeze(sp_PGGs.spGPGGs(2,:,1:20480));
gazes_R_all=squeeze(sp_PGGs.spGPGGs(1,:,20481:40960));
gels_R_all=squeeze(sp_PGGs.spGPGGs(2,:,20481:40960));
...
for S=1:1000
	...
	OutOfMaskL=setdiff([1:20480],MasterMaskL);
	OutOfMaskR=setdiff([1:20480],MasterMaskR);
	% merge ang distances
...
% save it out
SpunAngDistFP=['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_SpunDips5.csv'];
