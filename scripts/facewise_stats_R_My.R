...
for (f in 1:Rfaces){
	...
	for (s in 1:remainingSubjs){
	    subj=df$SubjID[s]
	    ResFP_R=paste0('/cbica/projects/pinesParcels/results/PWs/Proced/',subj,'/',subj,'_BUTD_R_My.csv')
	    # if output exists
...
saveRDS(BuProp_adr2,paste0('/cbica/projects/pinesParcels/results/PWs/RBUProp_adr2_My.rds'))
#saveRDS(BuProp_sdr2,'/cbica/projects/pinesParcels/results/PWs/RBUProp_sdr2.rds')

saveRDS(BuProp_ap,paste0('/cbica/projects/pinesParcels/results/PWs/RBUProp_p_My.rds'))
