...
ED_f_l=vroom('Y:/results/PWs/face_EucD_left.csv')
ED_f_r=vroom('Y:/results/PWs/face_EucD_right.csv')

### Load in CFC

cfc_l=vroom('Y:/results/PWs/FC/gro_CFC_l.csv',col_names=FALSE)
cfc_r=vroom('Y:/results/PWs/FC/gro_CFC_r.csv',col_names=FALSE)
