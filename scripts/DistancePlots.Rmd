...
# initialize bins
DistBin=matrix(0,8000000,13)
Threshs=seq(0,180,15)
...
FCED<-ggplot(df, aes(y = FC, x = Euclidean_Distance)) +
  geom_hex(bins = 100)+scale_fill_gradient2(mid='gray90',high='black',limits=c(0,8600))+theme_classic()+geom_point(alpha=0)
...
PlotdfPoses<-rbind(plotdfPos,plotdfPosC)
