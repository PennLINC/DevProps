...
for s=1:numSubjs
	...
	if isfile(outFP_L);
		...
		csv_L=table(matL(:,[1 6:8]));
		csv_R=table(matR(:,[1 6:8]));
		writetable(csv_L,['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_BUTD_L_c.csv'])
		writetable(csv_R,['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_BUTD_R_c.csv'])
	end
end
