...
templatefileFP=paste0('/cbica/projects/pinesParcels/results/PWs/Proced/', subj, '/', subj, '_FC_R_pt', as.character(iter), '.rds')
...
for (s in 1:remainingSubjs){
	...
	fp=paste0('/cbica/projects/pinesParcels/results/PWs/Proced/', subj, '/', subj, '_FC_R_pt', as.character(iter), '.rds')
...
DR2VecName=paste('/cbica/projects/pinesParcels/results/PWs/Age_EdgeLeve_FC_R_DR2_',iter,'.rds',sep='')
