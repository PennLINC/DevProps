# submit this as chunks: run over one of 15 different sets of faces
VertBin=commandArgs(trailingOnly=TRUE)
# note, start with 0, use 15 to get remainders!
...
Lfaces=18520
Rfaces=18546
# 1234 goes into 18520 15 times
startL=(VertBin*1234)+1
endL=(VertBin+1)*1234
# 1236 for 18546
startR=(VertBin*1236)+1
endR=(VertBin+1)*1236
# addendum for remainders, as noted above
if (VertBin==15){
	endL=Lfaces
	emdR=Rfaces
}
