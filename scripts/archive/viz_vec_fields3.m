...
OpFlFp=['/cbica/projects/pinesParcels/results/PWs/Proced/' subj '/' subj '_OpFl_fs3.mat'];
OpFl=load(OpFlFp);
OpFl=OpFl.us;
...
TRs_lfp=['/cbica/projects/pinesParcels/results/PWs/PreProc/' subj '/' subj '_AggTS_L_1k.mgh'];
TRs_rfp=['/cbica/projects/pinesParcels/results/PWs/PreProc/' subj '/' subj '_AggTS_R_1k.mgh'];
% filepaths to files
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% load in group PG %%%%%
LPGfp=['/cbica/projects/pinesParcels/data/princ_gradients/hcp.gradients_L_1k.func.gii'];
LPGf=gifti(LPGfp);
PG_LH=LPGf.cdata(:,1);
% right hemi
RPGfp=['/cbica/projects/pinesParcels/data/princ_gradients/hcp.gradients_R_1k.func.gii'];
RPGf=gifti(RPGfp);
PG_RH=RPGf.cdata(:,1);
...
video = VideoWriter([vizdir 'testDirecVecs_fs3.avi'],'Uncompressed AVI');
video.FrameRate = 2;
